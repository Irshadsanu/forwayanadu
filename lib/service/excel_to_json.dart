...
//     if (file != null && file.files.isNotEmpty) {
//       var bytes = file.files.single.bytes!;
//       print(file.files.first.name+'FMRKFMKRF');
//       if(!file.files.first.name.contains('.xlsx')){
//
//         print('MVCFKJVMJFVVN');
//
//       }
...
//               for (var key in keys) {
//
//                 print(key.toString()+'cfijvnignbg');
//
//
//                 tk = key.value.toString();
//                 print(tk.toString()+'vfrgvigjrn');
//                 // print("6");
//                 print(row[j].runtimeType.toString()+'CNUDICBUHFCBUHF');
//
//                 temp[tk] = (row[j].runtimeType == String)
//                     ? "\u201C" + row[j].value.toString() + "\u201D"
//                     :(row[j].runtimeType.toString() =='Null')?'': row[j].value.toString();
//                 // print("7");
//                 j++;
//               }
//               json.add(temp);
