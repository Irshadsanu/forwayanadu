...
class TopPanchayathReport extends StatelessWidget {
  const TopPanchayathReport({Key? key}) : super(key: key);
  ...
  Widget mobile(context) {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          //               child: Text('Top Panchayath',style: wardAppbarTxt),
          //             ),
          //
          //
          //           ],),
            ...
            child: Column(
              children: [
                Consumer<HomeProvider>(builder: (context, value, child) {
                  return value.topPanchayathListNew.isNotEmpty?ListView.builder(
                      padding: const EdgeInsets.only(top: 10),
                      physics: const ScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: value.topPanchayathListNew.length,
                      itemBuilder: (BuildContext context, int index) {
                        List<Color> border = [];
                        border = homeProvider.getcolors(index);
                        var item = value.topPanchayathListNew[index];
                        return InkWell(
                          onTap: (){
