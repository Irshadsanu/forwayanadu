...
class TopWardReport extends StatelessWidget {
  const TopWardReport({Key? key}) : super(key: key);
    ...
    return SafeArea(
      child: Scaffold(
        backgroundColor: myWhite,
          ...
          //               child: Text('Top 100 Unit',style: wardAppbarTxt),
          //             ),
          //
          //
          //           ],),
                                ...
                                Stack(
                                  children: [
                                    SizedBox(
                                      ...
                                      height:75,
                                      child: Padding(
                                        padding:  const EdgeInsets.only(bottom: 10.5,left: 10.8,top: 5),
                                        child: Image.asset('assets/leaderBadge.png',),
                                      ),
                                    ),
                                    Positioned(
                                        top:20,
                                        left: index+1>=100?30:30,
                                        child: SizedBox(width: 25,
                                            child: Center(child: Text((index+1).toString(),style:
                                            TextStyle(color: myWhite,fontWeight: FontWeight.bold,fontSize:12),)))),
                                  ],
                                ),
                                Flexible(
                                  fit: FlexFit.tight,
                                    ...
                                    child: FittedBox(
                                      child: Row(
                                        children: [
                                           Text("₹ ",
                                            style: TextStyle(
                                                color: index==0||index==1||index==2?Colors.white:Colors.black,fontWeight: FontWeight.w700,fontSize: 18),),
