...
class KmccHistory extends StatefulWidget {
  KmccHistory({Key? key}) : super(key: key);

  @override
  State<KmccHistory> createState() => _KmccHistoryState();
}

class _KmccHistoryState extends State<KmccHistory> {
                          ...
                          fieldViewBuilder: (
                            ...
                            return TextField(
                              ...
                              decoration:  InputDecoration(
                                ...
                                hintStyle: grayB12,
                                hintText:'Select National Committee',
                          ...
                          fieldViewBuilder: (
                            ...
                            return TextField(
                              ...
                              decoration:  InputDecoration(
                                contentPadding: const EdgeInsets.symmetric(vertical: 15),
                                hintStyle: grayB12,
                                hintText:'Select Area Committee',
                                focusedBorder: border,
                                enabledBorder: border,
                                errorBorder: border,
                                disabledBorder: border,
